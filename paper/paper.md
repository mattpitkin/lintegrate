...
of C integration functions, equivalent to functions in GSL, that allow researcher to integrate a function
...
range. In these cases, to obtain marginalised results (i.e., integrate) over some subset of the
...
lintegrate allows to calculate the logarithm of $Z$ in \autoref{eq:Z}, while working with the
